...
var format_webpaginas_2 = new ol.format.GeoJSON();
var features_webpaginas_2 = format_webpaginas_2.readFeatures(json_webpaginas_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_webpaginas_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_webpaginas_2.addFeatures(features_webpaginas_2);
var lyr_webpaginas_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_webpaginas_2, 
                style: style_webpaginas_2,
                popuplayertitle: 'webpaginas',
                interactive: true,
                title: '<img src="styles/legend/webpaginas_2.png" /> webpaginas'
            });
var format_boeken_3 = new ol.format.GeoJSON();
var features_boeken_3 = format_boeken_3.readFeatures(json_boeken_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_boeken_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_boeken_3.addFeatures(features_boeken_3);
var lyr_boeken_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_boeken_3, 
                style: style_boeken_3,
                popuplayertitle: 'boeken',
                interactive: true,
                title: '<img src="styles/legend/boeken_3.png" /> boeken'
            });
...
var format_oostbrabant_8 = new ol.format.GeoJSON();
var features_oostbrabant_8 = format_oostbrabant_8.readFeatures(json_oostbrabant_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_oostbrabant_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_oostbrabant_8.addFeatures(features_oostbrabant_8);
var lyr_oostbrabant_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_oostbrabant_8, 
                style: style_oostbrabant_8,
                popuplayertitle: 'oostbrabant',
                interactive: true,
                title: '<img src="styles/legend/oostbrabant_8.png" /> oostbrabant'
            });
...
lyr_EsriStreet_0.setVisible(true);lyr_pers_1.setVisible(true);lyr_webpaginas_2.setVisible(true);lyr_boeken_3.setVisible(true);lyr_kunstenaars_4.setVisible(true);lyr_kerkfotografie_5.setVisible(true);lyr_mijnstreek_6.setVisible(true);lyr_maas_en_waal_7.setVisible(true);lyr_oostbrabant_8.setVisible(true);lyr_beeldbankRCE_9.setVisible(true);lyr_limburg_10.setVisible(true);
var layersList = [lyr_EsriStreet_0,lyr_pers_1,lyr_webpaginas_2,lyr_boeken_3,lyr_kunstenaars_4,lyr_kerkfotografie_5,lyr_mijnstreek_6,lyr_maas_en_waal_7,lyr_oostbrabant_8,lyr_beeldbankRCE_9,lyr_limburg_10];
lyr_pers_1.set('fieldAliases', {'id': 'id', 'plaats': 'plaats', 'gebouw': 'gebouw', 'link': 'link', 'trefwoord': 'trefwoord', 'link_id': 'link_id', });
lyr_webpaginas_2.set('fieldAliases', {'id': 'id', 'plaats': 'plaats', 'link': 'link', 'gebouw': 'gebouw', 'extra': 'extra', 'trefwoord': 'trefwoord', 'link_id': 'link_id', });
lyr_boeken_3.set('fieldAliases', {'id': 'id', 'plaats': 'plaats', 'gebouw': 'gebouw', 'titel': 'titel', 'auteur': 'auteur', 'uitgever': 'uitgever', 'isbn': 'isbn', 'trefwoord': 'trefwoord', });
...
lyr_oostbrabant_8.set('fieldAliases', {'id': 'id', 'plaats': 'plaats', 'gebouw': 'gebouw', 'link': 'link', 'trefwoord': 'trefwoord', 'link_id': 'link_id', });
...
lyr_pers_1.set('fieldImages', {'id': 'TextEdit', 'plaats': 'TextEdit', 'gebouw': 'TextEdit', 'link': 'TextEdit', 'trefwoord': 'TextEdit', 'link_id': 'TextEdit', });
lyr_webpaginas_2.set('fieldImages', {'id': 'TextEdit', 'plaats': 'TextEdit', 'link': 'TextEdit', 'gebouw': 'TextEdit', 'extra': 'TextEdit', 'trefwoord': 'TextEdit', 'link_id': 'TextEdit', });
lyr_boeken_3.set('fieldImages', {'id': 'TextEdit', 'plaats': 'TextEdit', 'gebouw': 'TextEdit', 'titel': 'TextEdit', 'auteur': 'TextEdit', 'uitgever': 'TextEdit', 'isbn': 'TextEdit', 'trefwoord': '', });
...
lyr_oostbrabant_8.set('fieldImages', {'id': 'TextEdit', 'plaats': 'TextEdit', 'gebouw': '', 'link': '', 'trefwoord': '', 'link_id': '', });
...
lyr_pers_1.set('fieldLabels', {'id': 'no label', 'plaats': 'no label', 'gebouw': 'no label', 'link': 'no label', 'trefwoord': 'no label', 'link_id': 'no label', });
lyr_webpaginas_2.set('fieldLabels', {'id': 'no label', 'plaats': 'no label', 'link': 'no label', 'gebouw': 'no label', 'extra': 'no label', 'trefwoord': 'no label', 'link_id': 'no label', });
lyr_boeken_3.set('fieldLabels', {'id': 'no label', 'plaats': 'no label', 'gebouw': 'no label', 'titel': 'no label', 'auteur': 'no label', 'uitgever': 'no label', 'isbn': 'no label', 'trefwoord': 'no label', });
...
lyr_oostbrabant_8.set('fieldLabels', {'id': 'no label', 'plaats': 'no label', 'gebouw': 'no label', 'link': 'no label', 'trefwoord': 'no label', 'link_id': 'no label', });
